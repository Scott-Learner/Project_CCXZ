...
if __name__ == '__main__':
    ...
    # Data loader (optional, can use dummy generator)
    parser.add_argument('--data', type=str, default='Electricity',
                        help='dataset type for reference')
    ...
    # Autoencoding task parameters
    parser.add_argument('--seq_len', type=int, default=8192,
                        help='signal sequence length (2^13 default)')
    ...
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_{}_L{}_ch{}_lr{}_lambda{}_bs{}_ep{}_{}'.format(
            args.task_name,
            args.model_id,
            args.model,
            args.data,
        ...
        args.num_channels = exp.args.num_channels 
