...
# Parameters aligned with WPMixer_ETTm1.sh
...
pretrained_ckpt=./checkpoints/autoencoding/ETTm1

# Wavelet parameters (must match autoencoding checkpoint)
wavelet_level=1  # ETTm1 autoencoding was trained with level=1
wavelet_name=db2

echo "============================================================"
echo "PretrainedWPMixer for ETTm1 Dataset (Parallel Checkpoint)"
